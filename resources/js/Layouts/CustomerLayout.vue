...
<template>
    ...
    <div class="row items-center">
        ...
        <q-tabs v-model="tab" shrink no-caps inline-label class="gt-sm">
            <Link :href="route('customer.products.index')">
                <q-tab name="products" label="Products" icon="fastfood" :class="tab == 'products' ? 'text-primary' : ''"/>
            </Link>
            <Link :href="route('customer.events.index')">
                <q-tab name="events" label="Events" icon="celebration" :class="tab == 'events' ? 'text-primary' : ''"/>
            </Link>
            <Link :href="route('customer.facilities.index')">
                <q-tab name="facilities" label="Facilities" icon="cottage" :class="tab == 'facilities' ? 'text-primary' : ''"/>
            </Link>
        </q-tabs>
    ...
    <div class="row">
        <div class="items-center flex">
            <q-input v-model="query" dense placeholder="Search..." @keyup.enter="search" outlined rounded class="q-mr-md gt-sm">
        ...
        <div v-if="!$page.props.auth.user">
            <div class="gt-sm">
                <Link :href="route('register')">
                    ...
                    <!-- <q-btn label="Sign up for free" rounded no-caps unelevated /> -->
                </Link>
        ...
        <div v-else class="flex">
            ...
            <q-btn class="q-px-xs" flat unelevated no-caps>
                ...
                <span class="q-ml-sm gt-sm">{{ $page.props.auth.user.first_name + ' ' + $page.props.auth.user.last_name }}</span>
            ...
            <!-- <q-btn round flat @click="drawer = !drawer" class="lt-md" icon="menu"/> -->
            
            <!-- <q-item class="q-pa-none q-ma-none q-mr-md">
...
<!-- <q-card class="fixed full-width lt-md" v-show="drawer">
    <q-list class="q-pa-none justify-end">
        <Link :href="route('customer.products.index')" class="text-subtitle2 navlink">
            <q-item clickable>
                ...
                <q-item-section side>Products</q-item-section>
            </q-item>
        </Link>
